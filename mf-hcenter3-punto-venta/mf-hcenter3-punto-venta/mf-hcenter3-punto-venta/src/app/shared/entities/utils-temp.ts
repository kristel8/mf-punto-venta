...
export class UtilsTemp {
    ...
    static VALIDATE_PASS_HISTORY = "/validationPassHistory";
    ...
    static TM_EXCHANGE_RATE_LIST_BY_APP= "/api/hcenterv3/api/tipocambioByApp";


    // public getUrlServer(apiDesc: string): string {
    //     const externalProperties:any[] = JSON.parse(localStorage.getItem('externalProperties'));

    //     let flag:boolean = false;
    //     let urlEndPoint:string = "";

    //     if(externalProperties != null){
    //         flag = externalProperties[0].externalFlag;
    //         urlEndPoint = externalProperties[0].urlEndPoint;
    //     }

    //     if(flag){
    //         // console.log("Flag en si");
    //         return urlEndPoint
    //     } else {
    //         // console.log("Flag en no");
    //         if (currentEnviroment == serverLocalhost["server"]) {
    //             //Codigo Probado // 17/03/2020
    //             let uriCurrent = null;
    //             localhostApi.forEach(element => {
    //                 if (apiDesc == element['apiDesc']) {
    //                     uriCurrent = element['uri'];
    //                 }
    //             })
    //             return uriCurrent;
